...
public class RabbitMQConfig {
    ...
    public static final String ANALYSIS_QUEUE = "analysis.score.queue";
    ...
    @Bean
    public Binding analysisBinding(Queue analysisQueue, TopicExchange scoreExchange) {
        return BindingBuilder.bind(analysisQueue).to(scoreExchange).with(ROUTING_KEY);
    }
